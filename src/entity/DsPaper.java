...
public class DsPaper  implements java.io.Serializable {
    ...
    public DsPaper(int ppStudentid, int ppCollegeid, int ppMajorid, int ppClassid, int ppTeacherid, int ppJudgerid, int ppReplyid, String ppTeacheradvice, String ppContent, String ppState, double rpContentscore, double rpReportscore, double rpInnovatescore, double rpReplyscore, double rpReplyremark, double rpDefenseremark, String rpRecordlist, double rpTotalscore, float jfJudgerscores, float jfScores1, float jfScores2, float jfScores3, float jfScores4, float jfScores5, float jfScores6, String jfJudgerremark, float tfTeacherscores, float tfScores1, float tfScores2, float tfScores3, float tfScores4, float tfScores5, float tfScores6, String tfTeacherremark) {
