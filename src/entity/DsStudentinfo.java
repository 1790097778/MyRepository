...
public class DsStudentinfo implements java.io.Serializable {
	...
	public DsStudentinfo(int stCollegeid, int stMajorid, int stClassid, int stTeacherid, int stPaperid, int stReplyid,
			int stPowerid, String stStuname, String stUsername, String stPassword) {
	...
	public DsStudentinfo(int stCollegeid, int stMajorid, int stClassid, int stTeacherid, int stPaperid,
			Integer stSubjectid, int stReplyid, int stPowerid, String stStuname, String stUsername, String stPassword,
			String stTelnumber, String stEmail, Float stScore) {
		this.stCollegeid = stCollegeid;
		this.stMajorid = stMajorid;
		this.stClassid = stClassid;
		this.stTeacherid = stTeacherid;
