	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="header">
					<a onclick="loadView('content/teacher_student.jsp','aaa',{id:3})">我的学生</a>>论文批改
				</div>
			</div>
			<div class="panel-body">
				<div class="table-responsive">
	                ...
	                <div style="text-align: center;"><button onclick="loadView('content/teacher_student.jsp','aaa',{id:3})" style="margin: auto;width: 120px;">提交保存</button></div>
				</div>
			</div>
		</div>
		<!--End Advanced Tables -->
